...
## 🚀 Featured Projects
**[TechFix](https://github.com/ren-rt/TechFix-mobile)** | Group poject-Android app for a multi-branch repair shop chain — built the discovery & repair-request flow with camera capture, GPS branch-assignment, and Firestore sync | Java, Android Studio, Firebase, SQLite |
 **[Cyber Attack Path Visualizer](https://github.com/ThimansaSanindi/Cyber-Attack-Path-Visualizer)** | Group project-Simulates and visualizes attack paths across a network graph using BFS | Java, Swing, Graph Algorithms |

## 📫 Connect with me
* LinkedIn: [LinkedIn](https://www.linkedin.com/in/thimansa-hewage-929197350)
* GitHub: [GitHub](https://github.com/ThimansaSanindi)
